...
import {loadEvaluation, loadEvaluationsRows} from "@/lib/services/api"
...
export default function Evaluation() {
    ...
    useEffect(() => {
        ...
        const init = async () => {
            const data = await loadEvaluationsRows(evaluationTableId, evaluation)
    ...
    return (
        <div style={{marginBottom: "200px"}}>
            {evaluationTableId && evaluationRows && evaluation && (
